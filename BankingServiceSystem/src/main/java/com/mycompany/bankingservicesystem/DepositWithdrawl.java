 ...
 * @author anura
 */
public class DepositWithdrawl extends javax.swing.JFrame {

    /**
     * Creates new form DepositWithdrawl
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepositWithdrawl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DepositWithdrawl().setVisible(true);
            }
        });
    }
